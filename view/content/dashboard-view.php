                ...
                <div class="card-body" data-simplebar style="height:355px; overflow-y: auto; overflow-x: hidden;">
                  ...
                  <div class="pb-3 timeline-item item-warning">
                    <div class="pl-5">
                      ...
                      <div class="row mb-3">
                        <div class="col"><img src="<?php echo SERVERURL?>view/assets/products/p1.jpg" alt="..." class="img-fluid rounded"></div>
                        <div class="col"><img src="<?php echo SERVERURL?>view/assets/products/p2.jpg" alt="..." class="img-fluid rounded"></div>
                        <div class="col"><img src="<?php echo SERVERURL?>view/assets/products/p3.jpg" alt="..." class="img-fluid rounded"></div>
                        <div class="col"><img src="<?php echo SERVERURL?>view/assets/products/p4.jpg" alt="..." class="img-fluid rounded"></div>
                      </div>
                      ...
                      <ul class="avatars-list mb-3">
                        <li>
                          <a href="#!" class="avatar avatar-sm">
                            <img alt="..." class="avatar-img rounded-circle" src="<?php echo SERVERURL?>view/assets/avatars/face-1.jpg">
                          </a>
                        </li>
                        <li>
                          <a href="#!" class="avatar avatar-sm">
                            <img alt="..." class="avatar-img rounded-circle" src="<?php echo SERVERURL?>view/assets/avatars/face-4.jpg">
                          </a>
                        </li>
                        <li>
                          <a href="#!" class="avatar avatar-sm">
                            <img alt="..." class="avatar-img rounded-circle" src="<?php echo SERVERURL?>view/assets/avatars/face-3.jpg">
                          </a>
                        </li>
                      </ul>
                      <p class="small text-muted">Front-End Development <span class="badge badge-light">1h ago</span>
