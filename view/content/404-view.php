<div class="wrapper vh-100">
      <div class="align-items-center h-100 d-flex w-50 mx-auto">
        <div class="mx-auto text-center">
          ...
          <h1 class="mb-1 text-muted font-weight-bold"><?php echo $_SESSION['rol'].$_SESSION['rol']; ?></h1>
          <h6 class="mb-3 text-muted">The page could not be found.</h6>
          <a href="<?php echo SERVERURL ?>salir" class="btn btn-lg btn-primary px-5">Back to Dashboard</a>
        </div>
      </div>
    </div>