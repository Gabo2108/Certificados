...
$path = "D:\\Server\\root\\Entregable\\certificados\\Moocs1\\";
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="container">
                            ...
                            <a href="registros.php" class="btn btn-success">Atras</a> 
                            </div>
                        </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a title="Descargar Archivo" href="../certificados/Moocs1/ <?php echo $rar[$i]; ?>" download="<?php echo $rar[$i]; ?>">
    ...
    $('.acciones').on("click", "#eliminar", function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                url: "../controlador/eliminar_mooc.php",
                type: "POST",
                datatype: "json",
                ...
                success: function (data) {
                    ...
                    if(smg=="ok"){
                        ...
                        if (result.value) {
                            location.href = "descarga_uno.php";
                        }})
